...
function AddFavorite(title, url) {
 ...
 <table width="700" border="1" >
  <tr>
    <th width="400" scope="col">地址</th>
    <th width="200" scope="col">电话</th>
    <th width="100" colspan="2" scope="col">操作</th>
  </tr>
  <c:forEach var="address" items="${addresslists}" varStatus="index">
     <tr>
    <th width="400">${address.getAaddress()}</th>
    <th width="200">${address.getAtel()}</th>
    <th width="70" ><div onClick="gai('${address.AID}')">修改</div> </th>
    <th width="30"><div style="color:red;"  onClick="shan('${address.AID}')">×</div></th>
  </tr>
      </c:forEach>
    <tr>
    <th colspan="4"><div style="height:30px;"></div></th>
    </tr>
    <tr>
    <form action="people_addaddress" method="post">
    <th width="400"><input name="Aaddress" type="text" style="width:390px;height:25px;"></th>
    <th width="200"><input name="Atel" type="text" style="width:190px;height:25px;"></th>
    <th width="100" colspan="2" ><input type="submit" value="添加"> </th>
    </form>
  </tr>
</table>
</div>
