...
<div class="right_under"> 
      ...
      <div class="right_table">
        ...
        <a href="people_order_ok"><div class="right_table_style bg">已评价</div></a>
      </div>
    </div>
    <div class="right_undertable">
       <ul>
       <c:forEach var="orderform" items="${orderformlists5}" varStatus="index">
        <li class="right_list">
           ...
           <div class="right_yujitime">预定时间：${orderform.getOwish()}</div>
           <div class="right_daodatime">到达时间：${orderform.getOarrival()}</div>
           <div class="right_yipingjia">评价：${orderform.getOpingjia()}</div>
