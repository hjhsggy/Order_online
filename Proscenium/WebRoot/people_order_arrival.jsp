...
<div class="right_under"> 
      ...
      <div class="right_table">
        ...
        <a href="people_order_arrival"><div class="right_table_style bg">待完成</div></a>
    ...
    <div class="right_undertable">
       <ul><c:forEach var="orderform" items="${orderformlists2}" varStatus="index">
        <li class="right_list">
