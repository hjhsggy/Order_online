...
<head>
<meta charset="utf-8">
<link href="src/css/collection.css" rel="stylesheet" type="text/css">
  ...
  <div class="left"> 
   功能管理
    ...
    <a href="jifen.jsp"><div class="left_button">我的积分</div></a>
     <a href="collection.jsp"><div class="left_button ready">我的收藏</div></a>
  </div>

<div class="main_1">
  <div class="btitle">我的收藏</div>
  <div class="b">
    <div class="b1"> 
          <div class="b11">
          <img src="src/img/jiahao.jpg" width="180" height="160">
          </div>
          <div class="b12">
                                   添加收藏
          </div> 
