...
<div class="right_under"> 
    ...
    <div class="right_undertable">
       <ul><form method="post" action="order_pingjia">
        <li class="right_list"><input type="hidden" name="OID" id="OID" value="${orderform.getOID()}">
           ...
           <div class="right_beizhu">${orderform.getOinfo()}</div>
           <div class="right_beizhu">输入评价<input type="text" id="OPingjia" name="OPingjia" style="height:20px;width:500px;" ></div>
         <div class="right_beizhu"><input type="submit" value="提交评价"></div>
         </li></form>
       </ul>
    </div>
