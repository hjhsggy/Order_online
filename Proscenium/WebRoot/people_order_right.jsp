...
<div class="title">
    ...
    <div class="title_fgroup">
      <div class="fgroup_a">
        ...
        <div class="title_title_order"><a href="#">订单查询</a></div>
...
function quxiao(OID){
if(confirm("确认删除？")){
            location.href = "order_del?OID="+OID;
            }
}
</script>  
...
<div class="container">
  ...
  <div class="left"> 
   功能管理
    ...
    <a href="people_order_index"><div class="left_button order">我的订单</div></a>
...
<div class="right_under"> 
      ...
      <div class="right_table">
        <a href="people_order_right"><div class="right_table_style bg">待确认</div></a>
    ...
    <div class="right_undertable">
       <ul>
          <c:forEach var="orderform" items="${orderformlists1}" varStatus="index">
        <li class="right_list">
           ...
           <div class="right_food">
            ...
            <span>${orderform.getOcount()}</span>元
             ...
             <div class="right_pingjia" onClick="quxiao('${orderform.getOID()}')">取消订单</div>
