...
public class order_indexServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		request.setAttribute("orderformlists4", list);
		request.getRequestDispatcher("people_order_index.jsp").forward(request,response);
	}
